...
export default function Home() {
  ...
  const { MIYORALife: MIYORALife } = useContext(MIYORALifeContext);
  ...
  useEffect(() => {
    MIYORALife.checkSettingOff(!showSettings);
  }, [showSettings, MIYORALife]);
  ...
  useEffect(() => {
    MIYORALife.initialize(
      viewer,
      bot,
      setSubconciousLogs,
      chatSpeaking,
    );
  }, [MIYORALife, bot, viewer]);
